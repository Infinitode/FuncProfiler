...
1. **Report Issues**  
   Use the [GitHub Issues page](https://github.com/Infinitode/FuncProfiler/issues) to report bugs or suggest features. Please include:
...
3. **Follow Licensing Requirements**  
   Ensure that any derivative works comply with the [license](https://github.com/infinitode/FuncProfiler/blob/main/LICENSE).

By contributing, you agree to abide by these guidelines and this project's [license](https://github.com/infinitode/FuncProfiler/blob/main/LICENSE). Thank you for helping make **FuncProfiler** better!